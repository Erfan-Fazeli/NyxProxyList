...
- **Detailed Security & Latency Telemetry:** Visual indicators for real-time response speed, SSL/HTTPS support, anonymity levels (Elite/Anonymous), and threat scores.
